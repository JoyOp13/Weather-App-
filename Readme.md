...
step1 : Go on https://share.google/RpalG3Meggmo0ZzrL and then create your api key By Creating your Account.

step2 : Then copy that key & go In API Explorer Section, Then Your API Key and select One city And Change Aqi Value To yes.
...
step4 : Run the Project On live server